...
/**
 * Transformer: Mango DM/Scene7 images.
 * Converts Scene7 <img> tags into anchors that survive markdown round-trip.
 * Runs in afterTransform only - block parsers need <img> during their phase.
 *
 * Source: All images use Scene7 via vanity domain media.mango.com/is/image/punto/...
 * Detected in migration-work/metadata.json .images.mapping keys.
 *
 * The companion auto-block in scripts/scripts.js (installed separately) rebuilds
 * these anchors into responsive <picture> elements at render time.
 */
